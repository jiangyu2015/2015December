...
define("zrender/dep/excanvas", ["require"], function (e) {
    return document.createElement("canvas").getContext ? G_vmlCanvasManager = !1 : function () {
        ...
        function z(t, n, r, i) {
            var s = t.fillStyle, u = t.scaleX_, a = t.scaleY_, f = i.x - r.x, l = i.y - r.y;
            if (s instanceof $) {
        ...
        q.clearRect = function () {
            ...
            var g = W(this, i, s), y = c / 2, b = h / 2, w = [], E = 10, S = 10, x = N = 1;
    ...
    function a(e) {
        if (typeof e == "object" && e !== null) {
            ...
            if (e instanceof Array) {
                t = [];
                for (var n = 0, r = e.length; n < r; n++)t[n] = a(e[n])
            } else if (!s[o.call(e)] && !u(e)) {
                t = {};
    ...
    function f(e, t, n, r) {
        if (t.hasOwnProperty(n)) {
            var i = e[n];
            if (typeof i == "object" && !s[o.call(i)] && !u(i))l(e[n], t[n], r); else if (r || !(n in e))e[n] = t[n]
        }
    }

    function l(e, t, n) {
        for (var r in t)f(e, t, r, n);
        return e
    }
    ...
    function v(e, t, r) {
        if (!e || !t)return;
        if (e.forEach && e.forEach === n)e.forEach(t, r); else if (e.length === +e.length)for (var i = 0, s = e.length; i < s; i++)t.call(r, e[i], i, e); else for (var o in e)e.hasOwnProperty(o) && t.call(r, e[o], o, e)
    }

    function m(e, t, n) {
        if (!e || !t)return;
        if (e.map && e.map === r)return e.map(t, n);
        var i = [];
        for (var s = 0, o = e.length; s < o; s++)i.push(t.call(n, e[s], s, e));
        return i
    }

    function g(e, t, n) {
        if (!e || !t)return;
        if (e.filter && e.filter === i)return e.filter(t, n);
        var r = [];
        for (var s = 0, o = e.length; s < o; s++)t.call(n, e[s], s, e) && r.push(e[s]);
        return r
    }
    ...
    var t = Array.prototype, n = t.forEach, r = t.map, i = t.filter, s = {
        "[object Function]": 1,
        "[object RegExp]": 1,
        "[object Date]": 1,
        "[object Error]": 1,
    ...
    return {inherits: d, clone: a, merge: l, getContext: h, indexOf: p, each: v, map: m, filter: g, bind: y}
    ...
    var t = e("./config"), n = e("./tool/env"), r = e("./tool/event"), i = e("./tool/util"), s = e("./tool/vector"), o = e("./tool/matrix"), u = t.EVENT, a = e("./mixin/Eventful"), f = ["resize", "click", "dblclick", "mousewheel", "mousemove", "mouseout", "mouseup", "mousedown", "touchstart", "touchend", "touchmove"], l = function (e) {
        if (window.G_vmlCanvasManager)return !0;
        e = e || window.event;
        var n = e.toElement || e.relatedTarget || e.srcElement || e.target;
        return n && n.className.match(t.elementClassName)
    }, c = {
        resize: function (e) {
            ...
            (n && n.clickable || !n) && this._clickThreshold < 5 && this._dispatchAgency(n, u.CLICK, e), this._mousemoveHandler(e)
        }, dblclick: function (e, t) {
            if (!l(e) && !t)return;
            e = e || window.event, e = this._zrenderEventFixed(e);
            var n = this._lastHover;
            (n && n.clickable || !n) && this._clickThreshold < 5 && this._dispatchAgency(n, u.DBLCLICK, e), this._mousemoveHandler(e)
        }, mousewheel: function (e, t) {
            if (!l(e) && !t)return;
            e = this._zrenderEventFixed(e);
            var n = e.wheelDelta || -e.detail, i = n > 0 ? 1.1 : 1 / 1.1, s = !1, o = this._mouseX, a = this._mouseY;
            this.painter.eachBuildinLayer(function (t) {
                var n = t.position;
                if (t.zoomable) {
                    t.__zoom = t.__zoom || 1;
                    var u = t.__zoom;
                    u *= i, u = Math.max(Math.min(t.maxZoom, u), t.minZoom), i = u / t.__zoom, t.__zoom = u, n[0] -= (o - n[0]) * (i - 1), n[1] -= (a - n[1]) * (i - 1), t.scale[0] *= i, t.scale[1] *= i, t.dirty = !0, s = !0, r.stop(e)
                }
            }), s && this.painter.refresh(), this._dispatchAgency(this._lastHover, u.MOUSEWHEEL, e), this._mousemoveHandler(e)
            ...
            var n = this._mouseX - this._lastX, i = this._mouseY - this._lastY;
            ...
            var s = "default";
            if (this._draggingTarget)this.storage.drift(this._draggingTarget.id, n, i), this._draggingTarget.modSelf(), this.storage.addHover(this._draggingTarget), this._clickThreshold++; else if (this._isMouseDown) {
                var o = !1;
                this.painter.eachBuildinLayer(function (e) {
                    e.panable && (s = "move", e.position[0] += n, e.position[1] += i, o = !0, e.dirty = !0)
                }), o && this.painter.refresh()
            }
            this._draggingTarget || this._hasfound && this._lastHover.draggable ? s = "move" : this._hasfound && this._lastHover.clickable && (s = "pointer"), this.root.style.cursor = s, this._dispatchAgency(this._lastHover, u.MOUSEMOVE, e), (this._draggingTarget || this._hasfound || this.storage.hasHoverShape()) && this.painter.refreshHover()
        }, mouseout: function (e, t) {
            if (!l(e) && !t)return;
            e = this._zrenderEventFixed(e);
            var n = e.toElement || e.relatedTarget;
            if (n != this.root)while (n && n.nodeType != 9) {
                if (n == this.root) {
            ...
            var n = new Date;
            n - this._lastTouchMoment < u.touchClickDelay && (this._mobileFindFixed(e), this._clickHandler(e), n - this._lastClickMoment < u.touchClickDelay / 2 && (this._dblclickHandler(e), this._lastHover && this._lastHover.clickable && r.stop(e)), this._lastClickMoment = n), this.painter.clearHover()
        }
    }, v = function (e, t, r) {
    ...
    v.prototype.on = function (e, t, n) {
    ...
    }, v.prototype._dispatchAgency = function (e, t, n, r) {
        ...
        if (e)s.cancelBubble || this.dispatch(t, s); else if (!r) {
            var u = {type: t, event: n};
    ...
    return v.prototype._mobileFindFixed = function (e) {
        ...
        for (var t = 0; !this._lastHover && t < m.length; t++) {
            var n = m[t];
    ...
    }, i.merge(v.prototype, a.prototype, !0), v
    ...
    function w(e, t, n, r, i) {
        var s = (t - e) * r + e, o = (n - t) * r + t, u = (o - s) * r + s;
        i[0] = e, i[1] = s, i[2] = u, i[3] = u, i[4] = o, i[5] = n
    }

    function E(e, r, i, a, f, l, c, h, p) {
    ...
    function h(e, t, n, r) {
        ...
        switch (i) {
            ...
            case"sector":
                var s = t.startAngle * Math.PI / 180, o = t.endAngle * Math.PI / 180;
    ...
    function _(e, t, n, r, i) {
        var s = 0, o = 0, u = 0, a = 0, f = 0, l = !0, c = !0;
        n = n || "fill";
        var h = n === "stroke" || n === "both", p = n === "fill" || n === "both";
        for (var d = 0; d < e.length; d++) {
            var b = e[d], w = b.points;
            if (l || b.command === "M") {
                if (d > 0) {
                    p && (s += N(o, u, a, f, r, i));
                    if (s !== 0)return !0
            ...
            switch (b.command) {
                ...
                case"Q":
                    ...
                    break;
                case"A":
                    var E = w[0], S = w[1], x = w[2], T = w[3], C = w[4], k = w[5], L = Math.cos(C) * x + E, _ = Math.sin(C) * T + S;
    ...
    var t = e("../tool/matrix"), n = e("../tool/vector"), r = [0, 0], i = t.translate, s = 5e-5, a = function () {
    ...
    return a.prototype = {
        constructor: a, updateNeedTransform: function () {
            this.needLocalTransform = u(this.rotation[0]) || u(this.position[0]) || u(this.position[1]) || u(this.scale[0] - 1) || u(this.scale[1] - 1)
            ...
            if (this.needLocalTransform) {
                ...
                if (u(s[0]) || u(s[1])) {
                    r[0] = -s[2] || 0, r[1] = -s[3] || 0;
                    var o = u(r[0]) || u(r[1]);
                    o && i(n, n, r), t.scale(n, n, s), o && (r[0] = -r[0], r[1] = -r[1], i(n, n, r))
                }
                if (this.rotation instanceof Array) {
                    if (this.rotation[0] !== 0) {
                        r[0] = -this.rotation[1] || 0, r[1] = -this.rotation[2] || 0;
                        var o = u(r[0]) || u(r[1]);
                        o && i(n, n, r), t.rotate(n, n, this.rotation[0]), o && (r[0] = -r[0], r[1] = -r[1], i(n, n, r))
                    }
                } else this.rotation !== 0 && t.rotate(n, n, this.rotation);
                (u(this.position[0]) || u(this.position[1])) && i(n, n, this.position)
            }
            e && (this.needLocalTransform ? t.mul(n, this.parent.transform, n) : t.copy(n, this.parent.transform)), this.transform = n, this.invTransform = this.invTransform || t.create(), t.invert(this.invTransform, n)
            ...
            return function (r) {
                ...
                if (o(e[0]) && o(e[1]))return;
                n.normalize(e, e);
                var s = this.scale;
                i[2] = e[0] * s[1], i[3] = e[1] * s[1], i[0] = e[1] * s[0], i[1] = -e[0] * s[0], i[4] = this.position[0], i[5] = this.position[1], this.decomposeTransform()
            }
            ...
            u(s - 1) && (s = Math.sqrt(s)), n[0] = e[4], n[1] = e[5], r[0] = t, r[1] = s, r[2] = r[3] = 0, i[0] = Math.atan2(-e[1] / s, e[0] / t), i[1] = i[2] = 0
        }, transformCoordToLocal: function (e, t) {
            var r = [e, t];
            return this.needTransform && this.invTransform && n.applyTransform(r, r, this.invTransform), r
        }
    }, a
    ...
    function g(e, t, n) {
        ...
        var r = [], i = (t[0] - e[0]) / n, s = (t[1] - e[1]) / n, o = (t[2] - e[2]) / n, u = (t[3] - e[3]) / n;
    ...
    var t = window.G_vmlCanvasManager, n = e("../tool/matrix"), r = e("../tool/guid"), i = e("../tool/util"), s = e("../tool/log"), o = e("../mixin/Transformable"), u = e("../mixin/Eventful"), l = function (e) {
        e = e || {}, this.id = e.id || r();
    ...
    l.prototype.setContext = function (e, t) {
        for (var n = 0, r = c.length; n < r; n++) {
            var i = c[n][0], s = t[i], o = c[n][1];
            typeof s != "undefined" && (e[o] = s)
        }
    };
    var h = n.create();
    return l.prototype.doClip = function (e) {
        if (this.__clipShapes && !t)for (var r = 0; r < this.__clipShapes.length; r++) {
        ...
        return t = r[0], n = r[1], this.isCoverRect(t, n) ? e("../tool/area").isInside(this, this.style, t, n) : !1
    }, l.prototype.isCoverRect = function (e, t) {
        ...
        e.fillStyle = r;
        var i = 10, s, o, u, f, l = t.textPosition || this.textPosition || "top";
        switch (l) {
            case"inside":
            case"top":
            case"bottom":
            ...
            case"start":
            case"end":
                var h = t.pointList || [[t.xStart || 0, t.yStart || 0], [t.xEnd || 0, t.yEnd || 0]], p = h.length;
                if (p < 2)return;
                var d, v, m, g;
                switch (l) {
                    case"start":
    ...
    function o(e, t, n) {
        var r = document.createElement(t), s = n.getWidth(), o = n.getHeight();
    ...
    var t = e("./mixin/Transformable"), n = e("./tool/util"), r = window.G_vmlCanvasManager, i = e("./config"), u = function (e, n) {
    ...
    return u.prototype.initContext = function () {
        ...
        var e = this.dom, t = this.ctx, n = e.width, s = e.height, o = this.clearColor && !r, u = this.motionBlur && !r, a = this.lastFrameAlpha, f = i.devicePixelRatio;
    ...
    var t = e("./config"), n = e("./tool/util"), r = e("./tool/log"), i = e("./loadingEffect/Base"), s = e("./Layer"), f = function (e, n) {
        ...
        this._domRoot = r, r.style.position = "relative", r.style.overflow = "hidden", r.style.width = this._width + "px", r.style.height = this._height + "px", e.appendChild(r), this._layers = {}, this._zlevelList = [], this._layerConfig = {}, this._loadingEffect = new i({}), this.shapeToImage = this._createShapeToImageProcessor(), this._bgDom = document.createElement("div"), this._bgDom.style.cssText = ["position:absolute;left:0px;top:0px;width:", this._width, "px;height:", this._height + "px;", "-webkit-user-select:none;user-select;none;", "-webkit-touch-callout:none;"].join(""), this._bgDom.setAttribute("data-zr-dom-id", "bg"), this._bgDom.className = t.elementClassName, r.appendChild(this._bgDom), this._bgDom.onselectstart = o;
        var u = new s("_zrender_hover_", this);
        this._layers.hover = u, r.appendChild(u.dom), u.initContext(), u.dom.onselectstart = o, u.dom.style["-webkit-user-select"] = "none", u.dom.style["user-select"] = "none", u.dom.style["-webkit-touch-callout"] = "none", this.refreshNextFrame = null
    };
    return f.prototype.render = function (e) {
        ...
        for (var r = 0; r < this._zlevelList.length; r++) {
            var i = this._zlevelList[r], s = this._layers[i];
        ...
        for (var u = 0, a = e.length; u < a; u++) {
            ...
            if ((i.dirty || n) && !f.invisible)if (!f.onbrush || f.onbrush && !f.onbrush(o, !1))if (t.catchBrushException)try {
        ...
        var n = this._zlevelList.length, i = null, s = -1;
        if (n > 0 && e > this._zlevelList[0]) {
            for (s = 0; s < n - 1; s++)if (this._zlevelList[s] < e && this._zlevelList[s + 1] > e)break;
        ...
        for (var n = 0; n < this._zlevelList.length; n++) {
            var r = this._zlevelList[n], i = this._layers[r];
        ...
        this.storage.iterShape(function (e) {
            if (!e.invisible)if (!e.onbrush || e.onbrush && !e.onbrush(u, !1))if (t.catchBrushException)try {
    ...
    return s.prototype.ignore = !1, s.prototype.children = function () {
        ...
        t >= 0 && this._children.splice(t, 1), e.parent = null, this._storage && (this._storage.delFromMap(e.id), e instanceof s && e.delChildrenFromStorage(this._storage))
    ...
    return s.prototype.iterShape = function (e, t) {
        ...
        t.sort(i);
        if (e)for (var n = 0, r = t.length; n < r; n++)t[n].updateTransform();
        return t
        ...
        if (e.ignore)return;
        e.updateTransform(), e.clipShape && (e.clipShape.parent = e, e.clipShape.updateTransform(), t ? (t = t.slice(), t.push(e.clipShape)) : t = [e.clipShape]);
        if (e.type == "group") {
        ...
        typeof e == "string" && (e = this._elements[e]);
        if (e) {
            e.modSelf();
            if (n)if (n.parent || n._storage || n.__clipShapes) {
                var r = {};
                for (var i in n) {
                    if (i === "parent" || i === "_storage" || i === "__clipShapes")continue;
    ...
    return n.prototype = {
        step: function (e) {
            ...
            return this.fire("frame", i), n == 1 ? this.loop ? (this.restart(), "restart") : (this.__needsRemove = !0, "destroy") : null
        }, restart: function () {
    ...
    return g.prototype = {
        when: function (e, t) {
            ...
            var r = this, i = this._setter, s = this._getter, o = e === "spline", u = function () {
                r._clipCount--;
                if (r._clipCount === 0) {
                    r._tracks = {};
                ...
                var v = a.length;
                if (!v)return;
                var g = a[0].value, y = h(g), b = !1, w = y && h(g[0]) ? 2 : 1;
                a.sort(function (e, t) {
                ...
                var C = 0, k = 0, L, T, A, O, M, _, D;
                if (b)var P = [0, 0, 0, 0];
                var H = function (e, t) {
                    if (t < k) {
                        L = Math.min(C + 1, v - 1);
                        for (T = L; T >= 0; T--)if (S[T] <= t)break;
                        T = Math.min(T, v - 2)
                    } else {
                        for (T = C; T < v; T++)if (S[T] > t)break;
                        T = Math.min(T - 1, v - 2)
                    }
                    C = T, k = t;
                    var n = S[T + 1] - S[T];
    ...
    f.version = "2.1.1", f.init = function (e) {
        var t = new c(r(), e);
        return a[t.id] = t, t
    ...
    var c = function (t, n) {
        this.id = t, this.env = e("./tool/env"), this.storage = new o, this.painter = new s(n, this.storage), this.handler = new i(n, this.storage, this.painter), this.animation = new u({stage: {update: l(this)}}), this.animation.start();
        var r = this;
        this.painter.refreshNextFrame = function () {
            r.refreshNextFrame()
        }, this._needsRefreshNextFrame = !1;
        var r = this, a = this.storage, f = a.delFromMap;
        a.delFromMap = function (e) {
            var t = a.get(e);
            r.stopAnimation(t), f.call(a, e)
        }
    };
    return c.prototype.getId = function () {
        ...
        if (e) {
            ...
            e.__animators == null && (e.__animators = []);
            var c = e.__animators, h = this.animation.animate(o, {loop: i}).during(function () {
                s.modShape(e)
            }).done(function () {
                var n = t.indexOf(e.__animators, h);
                n >= 0 && c.splice(n, 1)
            });
            return c.push(h), h
        }
        ...
        if (e.__animators) {
            var t = e.__animators, n = t.length;
            for (var r = 0; r < n; r++)t[r].stop();
            t.length = 0
        }
        return this
        ...
        this.animation.stop(), this.clear(), this.storage.dispose(), this.painter.dispose(), this.handler.dispose(), this.animation = this.storage = this.painter = this.handler = null, f.delInstance(this.id)
    }, f
    ...
    return n.prototype = {
        type: "rose", buildPath: function (t, n) {
            var r, i, s = n.r, o, u = n.k, a = n.n || 1, f = n.x, l = n.y, c = e("../tool/math");
            t.moveTo(f, l);
    ...
    return n.prototype = {
        type: "trochoid", buildPath: function (t, n) {
            var r, i, s, o, u = n.r, a = n.r0, f = n.d, l = n.x, c = n.y, h = n.location == "out" ? 1 : -1, p = e("../tool/math");
            if (n.location && u <= a) {
                alert("参数错误");
                return
            }
            ...
            if (e.__rect)return e.__rect;
            var t = e.r, n = e.r0, r = e.d, i = e.location == "out" ? 1 : -1, s = t + r + i * n, o = e.x, u = e.y, a;
    ...
    return n.prototype = {
        type: "circle", buildPath: function (e, t) {
            e.moveTo(t.x + t.r, t.y), e.arc(t.x, t.y, t.r, 0, Math.PI * 2, !0);
            return
        }, getRect: function (e) {
            if (e.__rect)return e.__rect;
            var t;
    ...
    function i(e, t, r, i, s, o) {
        ...
        var l = Math.min.apply(null, u), c = Math.max.apply(null, u), h = Math.min.apply(null, f), p = Math.max.apply(null, f);
        s[0] = l, s[1] = h, o[0] = c, o[1] = p
    }

    function s(e, t, r, i, s) {
        var o = n.quadraticExtremum(e[0], t[0], r[0]), u = n.quadraticExtremum(e[1], t[1], r[1]);
        o = Math.max(Math.min(o, 1), 0), u = Math.max(Math.min(u, 1), 0);
        var a = 1 - o, f = 1 - u, l = a * a * e[0] + 2 * a * o * t[0] + o * o * r[0], c = a * a * e[1] + 2 * a * o * t[1] + o * o * r[1], h = f * f * e[0] + 2 * f * u * t[0] + u * u * r[0], p = f * f * e[1] + 2 * f * u * t[1] + u * u * r[1];
        i[0] = Math.min(e[0], r[0], l, h), i[1] = Math.min(e[1], r[1], c, p), s[0] = Math.max(e[0], r[0], l, h), s[1] = Math.max(e[1], r[1], c, p)
    }

    var t = e("./vector"), n = e("./curve"), o = t.create(), u = t.create(), a = t.create(), f = function (e, n, r, i, s, f, l, c) {
    ...
    var t = e("../tool/math"), n = e("../tool/computeBoundingBox"), r = e("../tool/vector"), i = e("./Base"), s = r.create(), o = r.create(), u = r.create(), a = r.create(), f = function (e) {
        i.call(this, e)
    };
    return f.prototype = {
        type: "sector", buildPath: function (e, n) {
            var r = n.x, i = n.y, s = n.r0 || 0, o = n.r, u = n.startAngle, a = n.endAngle, f = n.clockWise || !1;
            u = t.degreeToRadian(u), a = t.degreeToRadian(a), f || (u = -u, a = -a);
            var l = t.cos(u), c = t.sin(u);
            ...
            if (e.__rect)return e.__rect;
            var i = e.x, f = e.y, l = e.r0 || 0, c = e.r, h = t.degreeToRadian(e.startAngle), p = t.degreeToRadian(e.endAngle), d = e.clockWise;
    ...
    var t = e("./Base"), n = e("./util/PathProxy"), r = e("../tool/area"), i = function (e) {
    ...
    return i.prototype = {
        type: "heart", buildPath: function (e, t) {
            ...
            e = n[0], t = n[1];
            if (this.isCoverRect(e, t))return r.isInsidePath(this._pathProxy.pathCommands, this.style.lineWidth, this.style.brushType, e, t)
        }
    ...
    return o.prototype = {
        type: "isogon", buildPath: function (e, t) {
            var s = t.n;
            if (!s || s < 2)return;
    ...
    return n.prototype = {
        type: "bezier-curve", buildPath: function (e, t) {
            ...
            var u = e.lineWidth || 1;
            return e.__rect = {x: t - u, y: n - u, width: r - t + u, height: i - n + u}, e.__rect
        }
    }, e("../tool/util").inherits(n, t), n
    ...
    return function (e, n, r, i) {
        ...
        return r && s.push(t.clone(s.shift())), s
    }
    ...
    return s.prototype = {
        type: "polyline", buildPath: function (e, t) {
            ...
            var s = Math.min(t.pointList.length, Math.round(t.pointListLength || t.pointList.length));
            if (t.smooth && t.smooth !== "spline") {
                t.controlPointList || this.updateControlPoints(t);
                var o = t.controlPointList;
                e.moveTo(r[0][0], r[0][1]);
                var u, a, f;
                for (var l = 0; l < s - 1; l++)u = o[l * 2], a = o[l * 2 + 1], f = r[l + 1], e.bezierCurveTo(u[0], u[1], a[0], a[1], f[0], f[1])
            } else {
                t.smooth === "spline" && (r = n(r), s = r.length);
                if (!t.lineType || t.lineType == "solid") {
                    e.moveTo(r[0][0], r[0][1]);
                    for (var l = 1; l < s; l++)e.lineTo(r[l][0], r[l][1])
                } else if (t.lineType == "dashed" || t.lineType == "dotted") {
                    var c = (t.lineWidth || 1) * (t.lineType == "dashed" ? 5 : 1);
                    e.moveTo(r[0][0], r[0][1]);
                    for (var l = 1; l < s; l++)i(e, r[l - 1][0], r[l - 1][1], r[l][0], r[l][1], c)
                }
            }
            return
        }, updateControlPoints: function (e) {
            e.controlPointList = r(e.pointList, e.smooth, !1, e.smoothConstraint)
        }, getRect: function (t) {
            return e("./Polygon").prototype.getRect(t)
        }
    }, e("../tool/util").inherits(s, t), s
}), define("zrender/shape/Path", ["require", "./Base", "./util/PathProxy", "../tool/util"], function (e) {
    var t = e("./Base"), n = e("./util/PathProxy"), r = n.PathSegment, i = function (e) {
    ...
    return u.prototype = {
        type: "path", buildPathArray: function (e, t, n) {
            ...
            for (o = 1; o < u.length; o++) {
                ...
                while (p.length > 0) {
                    if (isNaN(p[0]))break;
                    var v = null, m = [], g, y, b, w, E, S, x, T, N = f, C = l;
                    switch (h) {
                        case"l":
            ...
            var c = l * (Math.PI / 180), h = Math.cos(c) * (e - n) / 2 + Math.sin(c) * (t - r) / 2, p = -1 * Math.sin(c) * (e - n) / 2 + Math.cos(c) * (t - r) / 2, d = h * h / (a * a) + p * p / (f * f);
            d > 1 && (a *= Math.sqrt(d), f *= Math.sqrt(d));
            var v = Math.sqrt((a * a * f * f - a * a * p * p - f * f * h * h) / (a * a * p * p + f * f * h * h));
            i === u && (v *= -1), isNaN(v) && (v = 0);
            var m = v * a * p / f, g = v * -f * h / a, y = (e + n) / 2 + Math.cos(c) * m - Math.sin(c) * g, b = (t + r) / 2 + Math.sin(c) * m + Math.cos(c) * g, w = o([1, 0], [(h - m) / a, (p - g) / f]), E = [(h - m) / a, (p - g) / f], S = [(-1 * h - m) / a, (-1 * p - g) / f], x = o(E, S);
            return s(E, S) <= -1 && (x = Math.PI), s(E, S) >= 1 && (x = 0), u === 0 && x > 0 && (x -= 2 * Math.PI), u === 1 && x < 0 && (x += 2 * Math.PI), [y, b, a, f, w, x, c, u]
        }, buildPath: function (e, t) {
            var n = t.path, r = t.x || 0, i = t.y || 0;
            t.pathArray = t.pathArray || this.buildPathArray(n, r, i);
            var s = t.pathArray, o = t.pointList = [], u = [];
            ...
            u.length > 0 && o.push(u);
            for (var a = 0, f = s.length; a < f; a++) {
                var p = s[a].command, l = s[a].points;
                switch (p) {
                    case"L":
                        e.lineTo(l[0], l[1]);
                        break;
                    ...
                    case"Q":
                        ...
                        break;
                    case"A":
                        var d = l[0], v = l[1], m = l[2], g = l[3], y = l[4], b = l[5], w = l[6], E = l[7], S = m > g ? m : g, x = m > g ? 1 : m / g, T = m > g ? g / m : 1;
            ...
            var n = Number.MAX_VALUE, r = Number.MIN_VALUE, i = Number.MAX_VALUE, s = Number.MIN_VALUE, o = e.x || 0, u = e.y || 0, a = e.pathArray || this.buildPathArray(e.path);
    ...
    return n.inherits(s, t), s.prototype._start = function (e, t) {
        ...
        }), o = this.createTextShape(s.textStyle), u = this.createBackgroundShape(s.backgroundColor), a = s.effect, f = a.n, l = a.brushType, c = a.lineWidth, h = [], p = this.canvasWidth, d = this.canvasHeight;
        for (var v = 0; v < f; v++) {
    ...
    return n.inherits(s, t), s.prototype._start = function (e, t) {
        ...
        }), o = this.createTextShape(s.textStyle), u = this.createBackgroundShape(s.backgroundColor), a = s.effectOption, f = a.n, l = a.lineWidth, c = [], h = this.canvasWidth, p = this.canvasHeight;
        for (var d = 0; d < f; d++) {
            var v = -Math.ceil(Math.random() * 1e3), m = Math.ceil(Math.random() * 400), g = Math.ceil(Math.random() * p), y = a.color == "random" ? r.random() : a.color;
            c[d] = new i({
                highlightStyle: {xStart: v, yStart: g, xEnd: v + m, yEnd: g, strokeColor: y, lineWidth: l},
    ...
    return n.inherits(o, t), o.prototype._start = function (e, t) {
        var o = n.merge(this.options, {
            ...
            backgroundColor: "rgba(0, 0, 0, 0.8)"
        }), u = this.createTextShape(o.textStyle), a = 10, f = i.getTextWidth(u.highlightStyle.text, u.highlightStyle.textFont), l = i.getTextHeight(u.highlightStyle.text, u.highlightStyle.textFont), c = n.merge(this.options.effect || {}, {
            r0: 9,
            r: 15,
            n: 18,
            color: "#fff",
    ...
    return n.inherits(u, t), u.prototype._start = function (e, t) {
        var u = n.merge(this.options, {
            ...
            backgroundColor: "rgba(250, 250, 250, 0.8)"
        }), a = this.createTextShape(u.textStyle), f = 10, l = r.getTextWidth(a.highlightStyle.text, a.highlightStyle.textFont), c = r.getTextHeight(a.highlightStyle.text, a.highlightStyle.textFont), h = n.merge(this.options.effect || {}, {
            r: 18,
            colorIn: "#fff",
            colorOut: "#555",
            colorWhirl: "#6cf",
...
define("zrender/shape/Cellular", ['require', './Base', '../tool/util'],
    function (require) {
        ...
        Cellular.prototype = {
            ...
            buildPath: function (ctx, style) {
                ...
                ctx.font = borderWidth * 2 / 3 + "px Verdana";
                ctx.save();
                var textAngle = (startAngle + endAngle) / 2;
                var targetX = x + cos(textAngle) * (radius + borderWidth / 6);
                var targetY = y + sin(textAngle) * (radius + borderWidth / 6);
                ctx.translate(targetX, targetY);
                ctx.rotate(PI / 2 + textAngle);
                ctx.translate(-targetX, -targetY);
                ctx.fillStyle = "#aaa"
