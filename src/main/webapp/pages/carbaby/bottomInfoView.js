...
define("bottomInfoView", ['require', 'zrender/tool/area', 'zrender/shape/Rectangle', 'zrender/shape/Text', 'utils'], function (require) {
    ...
    return {
        show: function (context, tipText, averageCostText, myCostText) {
            var zr = context.zr;
            var centerX = context.centerX;
            var centerY = context.centerY;
            var width = context.width;
            var baseHeight = centerX * 2 - 15;
            ...
            averageLine = utils.getLineShape(LineShape, lineStartX, firstLineBaseHeight, costTextStartX - 10, firstLineBaseHeight, baseColor1, 4, 1);

            myCost = utils.getTextShape(TextShape, costTextStartX, secondLineBaseHeight, myCostText, '#000', costTextFontSize);
            myLine = utils.getLineShape(LineShape, lineStartX, secondLineBaseHeight, costTextStartX - 25, secondLineBaseHeight, baseColor2, 4, 1);
